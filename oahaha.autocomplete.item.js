...
var oahahaAutocompleteItem = (function() {
    "use strict";
    ...
    return {
        ...
        initialize: function(elementID, ajaxID, items2Submit) {
            ...
            function addAutocomplete(dataJSON) {
                ...
                $j('#' + elementID).bind("keydown", function(event) {
                ...
                $j('#' + elementID).data("ui-autocomplete")._renderItem = function(ul, item) {
                    if (item.IMAGE == '') {
